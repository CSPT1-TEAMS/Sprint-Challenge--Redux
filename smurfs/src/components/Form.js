...
class Form extends Component {
  ...
  handleCancel = _e => {
    this.props.cancelEdit() // what's up with the underscore?
  }
  ...
  render() {
    ...
    return (
      <form onSubmit={editing ? this.handleUpdate : this.handleSubmit}>
        ...
        {editing ? 
          <span>
            <input type="submit" value="Save a smurf!"/>
              <buttun onClick={this.handleCancel}>Cancel Edit</button>
          </span> // what exactly is <span>?
